...
public class ExtendedKeyUsageModel extends AbstractExtensionModel {
   ...
   */
  public ExtendedKeyUsageModel(boolean critical, KeyPurposeId... keyPurposeIds) {
    extendedKeyUsage = new ExtendedKeyUsage(keyPurposeIds);
   ...
   * @param keyPurposeIds one or more key purpose IDs
   */
  public ExtendedKeyUsageModel(KeyPurposeId... keyPurposeIds) {
    extendedKeyUsage = new ExtendedKeyUsage(keyPurposeIds);
    this.critical = true;
  }
  ...
  @Override protected ExtensionMetadata getExtensionMetadata() {
    return new ExtensionMetadata(Extension.extendedKeyUsage, "Extended key usage", critical);
  }

  /** {@inheritDoc} */
  @Override protected ASN1Object getExtensionObject() throws CertificateIssuanceException {
    if (extendedKeyUsage.getUsages() == null || extendedKeyUsage.getUsages().length == 0) {
