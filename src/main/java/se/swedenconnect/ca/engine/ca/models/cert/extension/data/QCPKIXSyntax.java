 ...
 *
 * <pre>
 * qcStatement-2 QC-STATEMENT ::= {
 *   SYNTAX SemanticsInformation IDENTIFIED BY id-qcs-pkixQCSyntax-v2 }
...
public class QCPKIXSyntax {
   ...
   */
  public QCPKIXSyntax(final Version version) {
   ...
   */
  public QCPKIXSyntax(final SemanticsInformation semanticsInformation) {
   ...
   * @param semanticsInformation semantics information
   */
  public QCPKIXSyntax(final Version version, final SemanticsInformation semanticsInformation) {
    this.version = version;
    this.semanticsInformation = semanticsInformation;
  }
