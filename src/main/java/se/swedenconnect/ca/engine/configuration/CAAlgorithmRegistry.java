...
public class CAAlgorithmRegistry {
  ...
  private static Map<String, SignatureAlgorithmProperties> supportedAlgoMap;
   ...
   *
   * @param signatureAlgorithmProperties the properties of the registered signature algorithm
   */
  public static void registerSupportedAlgorithm(final SignatureAlgorithmProperties signatureAlgorithmProperties) {
  ...
  public static void removeRegisteredAlgorithm(String algorithm) {
    ...
    supportedAlgoMap.remove(algorithm);
  }
  ...
  private static void putAlgo(final SignatureAlgorithmProperties signatureAlgorithmProperties) {
